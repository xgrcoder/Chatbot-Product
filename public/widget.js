...
(function () {
  ...
  function injectStyles(primary, accent, dark) {
    ...
    var css = [
      ...
      '-webkit-tap-highlight-color:rgba(0,0,0,0)!important;outline:0!important;box-shadow:none!important}',
      ...
      'resize:none;outline:0!important;min-height:40px;max-height:120px;overflow-y:auto;transition:border-color .2s;',
      '-webkit-appearance:none;-webkit-tap-highlight-color:rgba(0,0,0,0)!important;',
      'box-shadow:none!important}',
      '#zp-input::placeholder{color:'+inputPh+'}',
      '#zp-input:focus{border-color:var(--zp-primary);outline:0!important;box-shadow:none!important}',
      '#zp-input:focus-visible{outline:0!important;box-shadow:none!important}',
      '#zp-input::-webkit-input-placeholder{color:'+inputPh+'}',
